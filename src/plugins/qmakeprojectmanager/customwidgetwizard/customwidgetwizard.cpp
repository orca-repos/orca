...
auto CustomWidgetWizard::create(QWidget *parent, const Core::WizardDialogParameters &parameters) const -> Core::BaseFileWizard*
{
...
auto CustomWidgetWizard::generateFiles(const QWizard *w, QString *errorMessage) const -> Core::GeneratedFiles
{
