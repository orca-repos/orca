...
static inline auto generateIconFile(const Utils::FilePath &source, const QString &target, QString *errorMessage) -> Core::GeneratedFile
{
  // Read out source
...
auto PluginGenerator::generatePlugin(const GenerationParameters &p, const PluginOptions &options, QString *errorMessage) -> QList<Core::GeneratedFile>
{
