...
auto QtWizard::postGenerateFiles(const QWizard *w, const Orca::Plugin::Core::GeneratedFiles &l, QString *errorMessage) const -> bool
{
  return QtWizard::qt4ProjectPostGenerateFiles(w, l, errorMessage);
}

auto QtWizard::qt4ProjectPostGenerateFiles(const QWizard *w, const Orca::Plugin::Core::GeneratedFiles &generatedFiles, QString *errorMessage) -> bool
{
...
{
  return Orca::Plugin::Core::ICore::resourcePath("templates/qt4project").toString();
}
...
auto QtWizard::lowerCaseFiles() -> bool
{
  ...
  return Orca::Plugin::Core::ICore::settings()->value(lowerCaseSettingsKey, QVariant(lowerCaseDefault)).toBool();
}

// ------------ CustomQmakeProjectWizard
CustomQmakeProjectWizard::CustomQmakeProjectWizard() = default;

auto CustomQmakeProjectWizard::create(QWidget *parent, const Orca::Plugin::Core::WizardDialogParameters &parameters) const -> Orca::Plugin::Core::BaseFileWizard*
{
...
auto CustomQmakeProjectWizard::postGenerateFiles(const QWizard *w, const Orca::Plugin::Core::GeneratedFiles &l, QString *errorMessage) const -> bool
{
  return QtWizard::qt4ProjectPostGenerateFiles(w, l, errorMessage);
}

// ----------------- BaseQmakeProjectWizardDialog
BaseQmakeProjectWizardDialog::BaseQmakeProjectWizardDialog(const Orca::Plugin::Core::BaseFileWizardFactory *factory, QWidget *parent, const Orca::Plugin::Core::WizardDialogParameters &parameters) : ProjectExplorer::BaseProjectWizardDialog(factory, parent, parameters)
{
...
BaseQmakeProjectWizardDialog::BaseQmakeProjectWizardDialog(const Orca::Plugin::Core::BaseFileWizardFactory *factory, Utils::ProjectIntroPage *introPage, int introId, QWidget *parent, const Orca::Plugin::Core::WizardDialogParameters &parameters) : ProjectExplorer::BaseProjectWizardDialog(factory, introPage, introId, parent, parameters)
{
  m_profileIds = Utils::transform(parameters.extraValues().value(ProjectExplorer::Constants::PROJECT_KIT_IDS).toStringList(), &Utils::Id::fromString);
  connect(this, &BaseProjectWizardDialog::projectParametersChanged, this, &BaseQmakeProjectWizardDialog::generateProfileName);
}
