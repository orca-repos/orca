...
ProFileEditorFactory::ProFileEditorFactory()
{
  ...
  Orca::Plugin::Core::registerIconOverlayForSuffix(orcaTheme()->imageFile(Theme::IconOverlayPro, defaultOverlay), "pro");
  Orca::Plugin::Core::registerIconOverlayForSuffix(orcaTheme()->imageFile(Theme::IconOverlayPri, defaultOverlay), "pri");
  Orca::Plugin::Core::registerIconOverlayForSuffix(orcaTheme()->imageFile(Theme::IconOverlayPrf, defaultOverlay), "prf");
}
