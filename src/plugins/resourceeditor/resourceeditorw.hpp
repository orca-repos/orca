...
class ResourceEditorDocument : public Core::IDocument {
  Q_OBJECT
...
public:
  ResourceEditorW(const Core::Context &context, ResourceEditorPlugin *plugin, QWidget *parent = nullptr);
  ~ResourceEditorW() override;

  // IEditor
  auto document() const -> Core::IDocument* override { return m_resourceDocument; }
