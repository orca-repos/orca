...
CMakeToolSettingsAccessor::CMakeToolSettingsAccessor() : UpgradingSettingsAccessor("QtCreatorCMakeTools", QCoreApplication::translate("CMakeProjectManager::CMakeToolManager", "CMake"), Core::Constants::IDE_DISPLAY_NAME)
{
...
auto CMakeToolSettingsAccessor::restoreCMakeTools(QWidget *parent) const -> CMakeToolSettingsAccessor::CMakeTools
{
  ...
  const auto sdkSettingsFile = Core::ICore::installerResourcePath(CMAKE_TOOL_FILENAME);
