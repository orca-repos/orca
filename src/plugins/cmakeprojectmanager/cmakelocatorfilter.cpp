...
auto CMakeTargetLocatorFilter::matchesFor(QFutureInterface<Core::LocatorFilterEntry> &future, const QString &entry) -> QList<Core::LocatorFilterEntry>
{
  Q_UNUSED(future)
  Q_UNUSED(entry)
  return m_result;
...
auto BuildCMakeTargetLocatorFilter::accept(const Core::LocatorFilterEntry &selection, QString *newText, int *selectionStart, int *selectionLength) const -> void
{
  Q_UNUSED(newText)
...
auto OpenCMakeTargetLocatorFilter::accept(const Core::LocatorFilterEntry &selection, QString *newText, int *selectionStart, int *selectionLength) const -> void
{
  Q_UNUSED(newText)
  Q_UNUSED(selectionStart)
  Q_UNUSED(selectionLength)
  ...
  if (line >= 0)
    Core::EditorManager::openEditorAt({file, line}, {}, Core::EditorManager::AllowExternalEditor);
  else
