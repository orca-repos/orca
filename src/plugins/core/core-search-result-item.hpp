...
#include "core-search-result-color.hpp"
...
public:
  ...
  auto mainRange() const -> TextRange { return m_main_range; }
  auto setMainRange(const TextRange &main_range) -> void { m_main_range = main_range; }
...
Q_DECLARE_METATYPE(Orca::Plugin::Core::SearchResultItem)
Q_DECLARE_METATYPE(Orca::Plugin::Core::TextPosition)
