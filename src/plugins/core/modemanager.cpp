...
struct ModeManagerPrivate {
  ...
  Internal::MainWindow *m_main_window{};
  Internal::FancyTabWidget *m_mode_stack{};
  Internal::FancyActionBar *m_action_bar{};
...
ModeManager::ModeManager(Internal::MainWindow *main_window, Internal::FancyTabWidget *modeStack)
{
  m_instance = this;
  ...
  d->m_old_current = -1;
  d->m_action_bar = new Internal::FancyActionBar(modeStack);
  d->m_mode_stack->addCornerWidget(d->m_action_bar);

  setModeStyle(d->m_mode_style);
  connect(d->m_mode_stack, &Internal::FancyTabWidget::currentAboutToShow, this, &ModeManager::currentTabAboutToChange);
  connect(d->m_mode_stack, &Internal::FancyTabWidget::currentChanged, this, &ModeManager::currentTabChanged);
  connect(d->m_mode_stack, &Internal::FancyTabWidget::menuTriggered, this, [](const int index, const QMouseEvent *e) { d->showMenu(index, e); });
}
