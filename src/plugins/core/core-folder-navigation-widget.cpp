...
constexpr int  SORT_ROLE = Qt::UserRole + 2;
constexpr char PROJECTSDIRECTORYROOT_ID[] = "A.Projects";
constexpr char C_FOLDERNAVIGATIONWIDGET[] = "ProjectExplorer.FolderNavigationWidget";
constexpr char kSettingsBase[] = "FolderNavigationWidget.";
constexpr char kHiddenFilesKey[] = ".HiddenFilesFilter";
constexpr char kSyncKey[] = ".SyncWithEditor";
constexpr char kShowBreadCrumbs[] = ".ShowBreadCrumbs";
constexpr char kSyncRootWithEditor[] = ".SyncRootWithEditor";
constexpr char kShowFoldersOnTop[] = ".ShowFoldersOnTop";
constexpr char ADDNEWFILE[] = "Orca.FileSystem.AddNewFile";
constexpr char RENAMEFILE[] = "Orca.FileSystem.RenameFile";
constexpr char REMOVEFILE[] = "Orca.FileSystem.RemoveFile";
...
FolderNavigationWidget::FolderNavigationWidget(QWidget *parent) : QWidget(parent), m_list_view(new NavigationTreeView(this)), m_file_system_model(new FolderNavigationModel(this)), m_sort_proxy_model(new FolderSortProxyModel(m_file_system_model)), m_filter_hidden_files_action(new QAction(tr("Show Hidden Files"), this)), m_show_bread_crumbs_action(new QAction(tr("Show Bread Crumbs"), this)), m_show_folders_on_top_action(new QAction(tr("Show Folders on Top"), this)), m_toggle_sync(new QToolButton(this)), m_toggle_root_sync(new QToolButton(this)), m_root_selector(new QComboBox), m_crumb_container(new QWidget(this)), m_crumb_label(new DelayedFileCrumbLabel(this))
{
  ...
  m_file_system_model->setIconProvider(iconProvider());
...
FolderNavigationWidgetFactory::FolderNavigationWidgetFactory()
{
  ...
  insertRootDirectory({QLatin1String("A.Computer"), 0 /*sortValue*/, FolderNavigationWidget::tr("Computer"), FilePath(), DESKTOP_DEVICE_SMALL.icon()});
