...
private:
  ...
  auto insertSideBarWidget(int position, const QString &id = QString()) -> Internal::SideBarWidget*;
  auto removeSideBarWidget(Internal::SideBarWidget *widget) const -> void;
