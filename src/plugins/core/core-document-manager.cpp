...
#include "core-file-properties-dialog.hpp"
#include "core-interface.hpp"
#include "core-readonly-files-dialog.hpp"
#include "core-save-items-dialog.hpp"
...
static constexpr char settingsGroupC[] = "RecentFiles";
static constexpr char filesKeyC[] = "Files";
static constexpr char editorsKeyC[] = "EditorIds";
static constexpr char directoryGroupC[] = "Directories";
static constexpr char projectDirectoryKeyC[] = "Projects";
static constexpr char useProjectDirectoryKeyC[] = "UseProjectsDirectory";
...
auto DocumentManagerPrivate::registerSaveAllAction() -> void
{
  ...
  const auto cmd = ActionManager::registerAction(m_save_all_action, SAVEALL);
...
#include "core-document-manager.moc"
