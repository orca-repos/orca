...
constexpr int kInitialWidth = 750;
constexpr int kInitialHeight = 450;
constexpr int kMaxMinimumWidth = 250;
constexpr int kMaxMinimumHeight = 250;

static constexpr char pageKeyC[] = "General/LastPreferencePage";
constexpr int categoryIconSize = 24;
...
SettingsDialog::SettingsDialog(QWidget *parent) : QDialog(parent), m_pages(sortedOptionsPages()), m_stacked_layout(new QStackedLayout), m_filter_line_edit(new FancyLineEdit), m_category_list(new CategoryListView), m_header_label(new QLabel)
{
  ...
  setWindowTitle(QCoreApplication::translate("Core::SettingsDialog", "Preferences"));
