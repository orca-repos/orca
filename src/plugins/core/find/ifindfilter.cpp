...
/*!
    ...
    \image orca-search-filesystem.png
...
{
  static const auto casesensitive_icon = Icons::FIND_CASE_INSENSITIVELY.pixmap();
  static const auto regexp_icon = Icons::FIND_REGEXP.pixmap();
  static const auto wholewords_icon = Icons::FIND_WHOLE_WORD.pixmap();
  static const auto preservecase_icon = Icons::FIND_PRESERVE_CASE.pixmap();
