...
public:
  explicit ShowOutputTaskHandler(Orca::Plugin::Core::IOutputPane *window, const QString &text, const QString &tooltip, const QString &shortcut);
...
private:
  Orca::Plugin::Core::IOutputPane *const m_window;
