...
ToolChainManager::ToolChainManager(QObject *parent) : QObject(parent)
{
  ...
  connect(Orca::Plugin::Core::ICore::instance(), &Orca::Plugin::Core::ICore::saveSettingsRequested, this, &ToolChainManager::saveToolChains);
...
auto ToolChainManager::restoreToolChains() -> void
{
  ...
  for (const auto tc : d->m_accessor->restoreToolChains(Orca::Plugin::Core::ICore::dialogParent()))
...
auto ToolChainManager::saveToolChains() -> void
{
  ...
  d->m_accessor->saveToolChains(d->m_toolChains, Orca::Plugin::Core::ICore::dialogParent());
