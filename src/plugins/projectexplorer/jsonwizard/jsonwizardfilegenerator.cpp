...
auto JsonWizardFileGenerator::generateFile(const File &file, Utils::MacroExpander *expander, QString *errorMessage) -> Core::GeneratedFile
{
...
auto JsonWizardFileGenerator::fileList(Utils::MacroExpander *expander, const QString &wizardDir, const QString &projectDir, QString *errorMessage) -> Core::GeneratedFiles
{
  errorMessage->clear();
  ...
  const Core::GeneratedFiles result = Utils::transform(fileList, [this, &expander, &errorMessage](const File &f) {
...
auto JsonWizardFileGenerator::writeFile(const JsonWizard *wizard, Core::GeneratedFile *file, QString *errorMessage) -> bool
{
  Q_UNUSED(wizard)
