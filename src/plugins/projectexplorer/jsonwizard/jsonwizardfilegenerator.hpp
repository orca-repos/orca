...
public:
  ...
  auto fileList(Utils::MacroExpander *expander, const QString &wizardDir, const QString &projectDir, QString *errorMessage) -> Core::GeneratedFiles override;
  auto writeFile(const JsonWizard *wizard, Core::GeneratedFile *file, QString *errorMessage) -> bool override;
...
private:
  ...
  auto generateFile(const File &file, Utils::MacroExpander *expander, QString *errorMessage) -> Core::GeneratedFile;
