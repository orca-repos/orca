...
public:
  ...
  virtual auto fileList(Utils::MacroExpander *expander, const QString &baseDir, const QString &projectDir, QString *errorMessage) -> Core::GeneratedFiles = 0;
  virtual auto formatFile(const JsonWizard *wizard, Core::GeneratedFile *file, QString *errorMessage) -> bool;
  virtual auto writeFile(const JsonWizard *wizard, Core::GeneratedFile *file, QString *errorMessage) -> bool;
  virtual auto postWrite(const JsonWizard *wizard, Core::GeneratedFile *file, QString *errorMessage) -> bool;
  virtual auto polish(const JsonWizard *wizard, Core::GeneratedFile *file, QString *errorMessage) -> bool;
  virtual auto allDone(const JsonWizard *wizard, Core::GeneratedFile *file, QString *errorMessage) -> bool;
