...
public:
    ...
    public:
        ...
        GeneratorFile(const Orca::Plugin::Core::GeneratedFile &f, JsonWizardGenerator *g) :
            file(f), generator(g)
        { }
    ...
    void removeAttributeFromAllFiles(Orca::Plugin::Core::GeneratedFile::Attribute a);
...
private:
    ...
    Orca::Plugin::Core::JsExpander m_jsExpander;
};
