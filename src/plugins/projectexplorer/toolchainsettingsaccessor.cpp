...
ToolChainSettingsAccessor::ToolChainSettingsAccessor() : UpgradingSettingsAccessor("QtCreatorToolChains", QCoreApplication::translate("ProjectExplorer::ToolChainManager", "Tool Chains"), Core::Constants::IDE_DISPLAY_NAME)
{
...
auto ToolChainSettingsAccessor::restoreToolChains(QWidget *parent) const -> Toolchains
{
  ...
  const auto systemFileTcs = toolChains(restoreSettings(Core::ICore::installerResourcePath(TOOLCHAIN_FILENAME), parent));
