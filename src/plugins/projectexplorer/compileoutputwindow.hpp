...
class CompileOutputWindow final : public Orca::Plugin::Core::IOutputPane {
  Q_OBJECT
...
private:
  ...
  auto outputWindows() const -> QList<Orca::Plugin::Core::OutputWindow*> override { return {m_outputWindow}; }
  auto loadSettings() -> void;
  auto storeSettings() const -> void;
  auto updateFromSettings() -> void;

  Orca::Plugin::Core::OutputWindow *m_outputWindow;
...
class CompileOutputSettingsPage final : public Orca::Plugin::Core::IOptionsPage {
public:
