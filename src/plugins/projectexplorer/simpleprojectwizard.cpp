...
auto generateQmakeFiles(const SimpleProjectWizardDialog *wizard, QString *errorMessage) -> GeneratedFiles
{
  ...
  generatedProFile.setContents("# Created by and for " + QLatin1String(Orca::Plugin::Core::IDE_DISPLAY_NAME) + " This file was created for editing the project sources only.\n" "# You may attempt to use it for building too, by modifying this file here.\n\n" "#TARGET = " + projectName + "\n\n" "QT = " + wizard->qtModules() + "\n\n" + proHeaders + "\n\n" + proSources + "\n\n" + proIncludes + "\n\n" "#DEFINES = \n\n");
