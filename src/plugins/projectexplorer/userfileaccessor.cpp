...
UserFileAccessor::UserFileAccessor(Project *project) : MergingSettingsAccessor(std::make_unique<VersionedBackUpStrategy>(this), "QtCreatorProject", project->displayName(), Orca::Plugin::Core::IDE_DISPLAY_NAME), m_project(project)
{
  // Setup:
