...
public:
  ...
  {
    helpCategory = Orca::Plugin::Core::HelpItem::Brief;
...
public:
  ...
  {
    helpCategory = Orca::Plugin::Core::HelpItem::Macro;
...
public:
  ...
  {
    helpCategory = Orca::Plugin::Core::HelpItem::ClassOrNamespace;
...
public:
  ...
  {
    helpCategory = Orca::Plugin::Core::HelpItem::Function;
...
public:
  ...
  {
    helpCategory = Orca::Plugin::Core::HelpItem::Enum;
    tooltip = qualifiedName;
  }
};
...
public:
  ...
  {
    helpCategory = Orca::Plugin::Core::HelpItem::Typedef;
    Overview overview;
    overview.showTemplateParameters = true;
    tooltip = overview.prettyType(declaration->type(), qualifiedName);
  }
