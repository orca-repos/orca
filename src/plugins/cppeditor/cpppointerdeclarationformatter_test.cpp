...
#include <texteditor/plaintexteditorfactory.hpp>

#include <utils/fileutils.hpp>

#include <cplusplus/Overview.hpp>
#include <cplusplus/pp.hpp>
...
public:
                                        ...
                                        PointerDeclarationFormatter::CursorHandling cursorHandling)
    {
        ...
        const QString filePath = temporaryDir.createFile("file.hpp",
