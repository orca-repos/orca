...
namespace Orca::Plugin::Core { class IEditor; }
...
public:
    ...
    void closeEditorAtEndOfTestCase(Orca::Plugin::Core::IEditor *editor);

    static bool closeEditorWithoutGarbageCollectorInvocation(Orca::Plugin::Core::IEditor *editor);
...
private:
    QList<Orca::Plugin::Core::IEditor *> m_editorsToClose;
