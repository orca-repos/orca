...
public:
  ...
  static auto isCppEditor(Orca::Plugin::Core::IEditor *editor) -> bool;
  ...
  auto setLocatorFilter(std::unique_ptr<Orca::Plugin::Core::ILocatorFilter> &&filter) -> void;
  auto setClassesFilter(std::unique_ptr<Orca::Plugin::Core::ILocatorFilter> &&filter) -> void;
  auto setIncludesFilter(std::unique_ptr<Orca::Plugin::Core::ILocatorFilter> &&filter) -> void;
  auto setFunctionsFilter(std::unique_ptr<Orca::Plugin::Core::ILocatorFilter> &&filter) -> void;
  auto setSymbolsFindFilter(std::unique_ptr<Orca::Plugin::Core::IFindFilter> &&filter) -> void;
  auto setCurrentDocumentFilter(std::unique_ptr<Orca::Plugin::Core::ILocatorFilter> &&filter) -> void;
  auto locatorFilter() const -> Orca::Plugin::Core::ILocatorFilter*;
  auto classesFilter() const -> Orca::Plugin::Core::ILocatorFilter*;
  auto includesFilter() const -> Orca::Plugin::Core::ILocatorFilter*;
  auto functionsFilter() const -> Orca::Plugin::Core::ILocatorFilter*;
  auto symbolsFindFilter() const -> Orca::Plugin::Core::IFindFilter*;
  auto currentDocumentFilter() const -> Orca::Plugin::Core::ILocatorFilter*;
...
private:
  ...
  auto onCurrentEditorChanged(Orca::Plugin::Core::IEditor *editor) -> void;
