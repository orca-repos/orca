 ...
 */
static auto firstTypeSpecifierWithoutFollowingAttribute(SpecifierListAST *list, TranslationUnit *translationUnit, unsigned endToken, bool *found) -> unsigned
{
    *found = false;
 ...
 */
auto PointerDeclarationFormatter::visit(SimpleDeclarationAST *ast) -> bool
{
...
auto PointerDeclarationFormatter::visit(FunctionDefinitionAST *ast) -> bool
{
    CHECK_RV(ast, "Invalid AST", true);
    printCandidate(ast);
...
auto PointerDeclarationFormatter::visit(ParameterDeclarationAST *ast) -> bool
{
    CHECK_RV(ast, "Invalid AST", true);
    printCandidate(ast);
...
auto PointerDeclarationFormatter::visit(ForeachStatementAST *ast) -> bool
{
    CHECK_RV(ast, "Invalid AST", true);
    printCandidate(ast);
...
auto PointerDeclarationFormatter::visit(IfStatementAST *ast) -> bool
{
    CHECK_RV(ast, "Invalid AST", true);
    printCandidate(ast);
...
auto PointerDeclarationFormatter::visit(WhileStatementAST *ast) -> bool
{
    CHECK_RV(ast, "Invalid AST", true);
    printCandidate(ast);
    processIfWhileForStatement(ast->condition, ast->symbol);
...
auto PointerDeclarationFormatter::visit(ForStatementAST *ast) -> bool
{
    CHECK_RV(ast, "Invalid AST", true);
    printCandidate(ast);
    processIfWhileForStatement(ast->condition, ast->symbol);
...
auto PointerDeclarationFormatter::processIfWhileForStatement(ExpressionAST *expression, Symbol *statementSymbol) -> void
{
 ...
 */
auto PointerDeclarationFormatter::checkAndRewrite(DeclaratorAST *declarator, Symbol *symbol, TokenRange tokenRange, unsigned charactersToRemove) -> void
{
    ...
    if (m_cursorHandling == RespectCursor) {
        const auto cursor = m_cppRefactoringFile->cursor();
...
auto PointerDeclarationFormatter::printCandidate(AST *ast) -> void
{
#if DEBUG_OUTPUT
    QString tokens;
