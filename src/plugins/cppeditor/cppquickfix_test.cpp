...
void QuickfixTest::testGenerateGetterSetterNamespaceHandlingCreate()
{
    ...
    QList<TestDocumentPtr> testDocuments(
        {CppTestDocument::create("file.hpp", headers.at(0), headers.at(1)),
...
private:
    ...
    testDocuments << CppTestDocument::create("file.hpp", original, expected);
...
void QuickfixTest::testGenerateGetterSetterOfferedFixes()
{
    ...
    QList<TestDocumentPtr> testDocuments(
        {CppTestDocument::create("file.hpp", header, header)});
...
void QuickfixTest::testGenerateGettersSetters()
{
    ...
    TestFactory factory;
    QuickFixOperationTest({CppTestDocument::create("file.hpp", original, expected)}, &factory);
}
...
void QuickfixTest::testInsertMemberFromInitialization()
{
    ...
    QList<TestDocumentPtr> testDocuments({
        CppTestDocument::create("file.hpp", original, expected)
    });
...
void QuickfixTest::testInsertDefFromDeclHeaderSourceBasic3()
{
    ...
    // Empty Header File
    testDocuments << CppTestDocument::create("file.hpp", "", "");
...
void QuickfixTest::testAddIncludeForUndefinedIdentifier_data()
{
    ...
    original = "class Foo {};\n";
    expected = original;
    testDocuments << CppTestDocument::create("afile.hpp", original, expected);
    ...
    expected = original;
    testDocuments << CppTestDocument::create("qmyclass.hpp", original, expected);
    ...
    QTest::newRow("firstGlobalIncludeAtBack")
            << TestIncludePaths::globalIncludePath()
            << testDocuments << firstRefactoringOperation << "<file.hpp>";
    testDocuments.clear();
    ...
    original =
        ...
        "#include <otherlib/file.hpp>\n"
        "#include <utils/file.hpp>\n"
        "\n@"
        ;
    expected =
        "#include <firstlib/file.hpp>\n"
        "#include <lib/file.hpp>\n"
        "#include <otherlib/file.hpp>\n"
        "#include <utils/file.hpp>\n"
        "\n"
    ...
    QTest::newRow("inserting_mixedDirsSorted")
            << TestIncludePaths::globalIncludePath()
            << testDocuments << firstRefactoringOperation << "<firstlib/file.hpp>";
    testDocuments.clear();
    ...
    expected =
        ...
        "#include <lib/file.hpp>\n"
        "#include <utils/file.hpp>\n"
        "#include <lastlib/file.hpp>\n"
        "\n"
        ;
    testDocuments << CppTestDocument::create("file.cpp", original, expected);
    QTest::newRow("inserting_mixedDirsUnsorted")
            << TestIncludePaths::globalIncludePath()
            << testDocuments << firstRefactoringOperation << "<lastlib/file.hpp>";
    testDocuments.clear();
    ...
    QTest::newRow("inserting_mixedIncludeTypes4")
            << TestIncludePaths::globalIncludePath()
            << testDocuments << firstRefactoringOperation << "<lib/file.hpp>";
    testDocuments.clear();
...
void QuickfixTest::testAddForwardDeclForUndefinedIdentifier_data()
{
    ...
    QTest::newRow("unqualified symbol")
            << QuickFixTestDocuments{CppTestDocument::create("theheader.hpp", original, expected)}
...
struct Derived : public Base {
    ...
    // Source File
    original = "#include \"file.h\"\n";
    expected = R"DELIM(#include "file.hpp"
...
void QuickfixTest::testRemoveUsingNamespace()
{
    ...
    QList<TestDocumentPtr> testDocuments;
    testDocuments << CppTestDocument::create("header1.hpp", header1, expected1);
    testDocuments << CppTestDocument::create("header2.hpp", header2, expected2);
    testDocuments << CppTestDocument::create("header3.hpp", header3, expected3);
...
void QuickfixTest::testRemoveUsingNamespaceSimple()
{
    ...
    QList<TestDocumentPtr> testDocuments;
    testDocuments << CppTestDocument::create("header.hpp", header, expected);
...
void QuickfixTest::testRemoveUsingNamespaceDifferentSymbols()
{
    ...
    QList<TestDocumentPtr> testDocuments;
    testDocuments << CppTestDocument::create("file.hpp", header, expected);
    RemoveUsingNamespace factory;
    QuickFixOperationTest(testDocuments, &factory, ProjectExplorer::HeaderPaths(), 0);
}
...
void QuickfixTest::testGenerateConstructor()
{
    ...
    QList<TestDocumentPtr> testDocuments;
    testDocuments << CppTestDocument::create("file.hpp", original_header, expected_header);
