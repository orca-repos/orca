...
void CodegenTest::testDefinitionEmptyClass()
{
    ...
    const QByteArray headerText = "\n"
            ...
            "};\n"
            "\n";
    Document::Ptr headerDocument = createDocumentAndFile(&temporaryDir, "file.hpp", headerText, 1);
...
void CodegenTest::testDefinitionFirstMember()
{
    ...
    QVERIFY(sourceDocument);
    sourceDocument->addIncludeFile(Document::Include(QLatin1String("file.hpp"),
...
void CodegenTest::testDefinitionMemberSpecificFile()
{
    ...
    const QByteArray headerText = "\n"
            ...
            "\n"
            "}\n";
    Document::Ptr headerDocument = createDocumentAndFile(&temporaryDir, "file.hpp", headerText, 2);
    QVERIFY(headerDocument);
