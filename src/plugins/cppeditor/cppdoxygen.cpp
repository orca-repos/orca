...
//       $ INPUT_FILE=${QTC_SOURCE}/src/plugins/cppeditor/cppdoxygen.kwgen
...
auto CppEditor::doxygenTagSpell(int index) -> const char* { return doxy_token_spell[index]; }

static inline auto classify1(const QChar *s) -> int
{
  if (s[0].unicode() == 'a') {
    return T_DOXY_A;
...
static inline auto classify2(const QChar *s) -> int
{
  if (s[0].unicode() == 'e') {
    if (s[1].unicode() == 'm') {
      return T_DOXY_EM;
...
static inline auto classify3(const QChar *s) -> int
{
  if (s[0].unicode() == 'a') {
    if (s[1].unicode() == 'r') {
      if (s[2].unicode() == 'g') {
...
static inline auto classify4(const QChar *s) -> int
{
  if (s[0].unicode() == 'b') {
    if (s[1].unicode() == 'o') {
      if (s[2].unicode() == 'l') {
...
static inline auto classify5(const QChar *s) -> int
{
  if (s[0].unicode() == 'b') {
    if (s[1].unicode() == 'r') {
      if (s[2].unicode() == 'i') {
...
static inline auto classify6(const QChar *s) -> int
{
  if (s[0].unicode() == 'a') {
    if (s[1].unicode() == 'n') {
      if (s[2].unicode() == 'c') {
...
static inline auto classify7(const QChar *s) -> int
{
  if (s[0].unicode() == 'a') {
    if (s[1].unicode() == 'u') {
      if (s[2].unicode() == 't') {
...
static inline auto classify8(const QChar *s) -> int
{
  if (s[0].unicode() == 'a') {
    if (s[1].unicode() == 'b') {
      if (s[2].unicode() == 's') {
...
static inline auto classify9(const QChar *s) -> int
{
  if (s[0].unicode() == 'a') {
    if (s[1].unicode() == 't') {
      if (s[2].unicode() == 't') {
...
static inline auto classify10(const QChar *s) -> int
{
  if (s[0].unicode() == 'a') {
    if (s[1].unicode() == 'd') {
      if (s[2].unicode() == 'd') {
...
static inline auto classify11(const QChar *s) -> int
{
  if (s[0].unicode() == 'c') {
    if (s[1].unicode() == 'a') {
      if (s[2].unicode() == 'l') {
...
static inline auto classify12(const QChar *s) -> int
{
  if (s[0].unicode() == 'c') {
    if (s[1].unicode() == 'o') {
      if (s[2].unicode() == 'n') {
...
static inline auto classify13(const QChar *s) -> int
{
  if (s[0].unicode() == 'a') {
    if (s[1].unicode() == 'n') {
      if (s[2].unicode() == 'n') {
...
static inline auto classify14(const QChar *s) -> int
{
  if (s[0].unicode() == 'e') {
    if (s[1].unicode() == 'n') {
      if (s[2].unicode() == 'd') {
...
static inline auto classify15(const QChar *s) -> int
{
  if (s[0].unicode() == 'h') {
    if (s[1].unicode() == 'i') {
      if (s[2].unicode() == 'd') {
...
static inline auto classify16(const QChar *s) -> int
{
  if (s[0].unicode() == 'p') {
    if (s[1].unicode() == 'r') {
      if (s[2].unicode() == 'o') {
...
static inline auto classify17(const QChar *s) -> int
{
  if (s[0].unicode() == 'q') {
    if (s[1].unicode() == 'm') {
      if (s[2].unicode() == 'l') {
...
static inline auto classify19(const QChar *s) -> int
{
  if (s[0].unicode() == 'q') {
    if (s[1].unicode() == 'm') {
      if (s[2].unicode() == 'l') {
...
auto CppEditor::classifyDoxygenTag(const QChar *s, int n) -> int
{
  switch (n) {
  case 1:
    return classify1(s);
