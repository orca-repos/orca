...
auto CppOutlineWidgetFactory::supportsEditor(Core::IEditor *editor) const -> bool
{
...
auto CppOutlineWidgetFactory::createWidget(Core::IEditor *editor) -> TextEditor::IOutlineWidget*
{
  const auto cppEditor = qobject_cast<TextEditor::BaseTextEditor*>(editor);
