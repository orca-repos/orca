...
CppEditorDocument::CppEditorDocument() : m_minimizableInfoBars(*infoBar())
{
  ...
  connect(this, &Orca::Plugin::Core::IDocument::mimeTypeChanged, this, &CppEditorDocument::onMimeTypeChanged);

  connect(this, &Orca::Plugin::Core::IDocument::aboutToReload, this, &CppEditorDocument::onAboutToReload);
  connect(this, &Orca::Plugin::Core::IDocument::reloadFinished, this, &CppEditorDocument::onReloadFinished);
...
auto CppEditorDocument::onFilePathChanged(const Utils::FilePath &oldPath, const Utils::FilePath &newPath) -> void
{
  ...
  if (!newPath.isEmpty()) {
    ...
    connect(this, &Orca::Plugin::Core::IDocument::contentsChanged, this, &CppEditorDocument::scheduleProcessDocument, Qt::UniqueConnection);
