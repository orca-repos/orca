...
class CodeGenSettingsPageWidget : public Orca::Plugin::Core::IOptionsPageWidget {
...
CodeGenSettingsPageWidget::CodeGenSettingsPageWidget()
{
  ...
  parameters.fromSettings(Orca::Plugin::Core::ICore::settings());
...
auto CodeGenSettingsPageWidget::apply() -> void
{
  ...
  rc.toSettings(Orca::Plugin::Core::ICore::settings());
}
