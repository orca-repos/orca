...
OutlineWidgetStack::OutlineWidgetStack(OutlineFactory *factory) : m_syncWithEditor(true), m_sorted(false)
{
  ...
  connect(Core::EditorManager::instance(), &Core::EditorManager::currentEditorChanged, this, &OutlineWidgetStack::updateEditor);
...
auto OutlineWidgetStack::updateEditor(Core::IEditor *editor) -> void
{
...
auto OutlineFactory::createWidget() -> Core::NavigationView
{
