...
public:
  ...
  virtual auto openEditor(const Orca::Plugin::Core::SearchResultItem &item, const FileFindParameters &parameters) -> Orca::Plugin::Core::IEditor* = 0;
...
class TEXTEDITOR_EXPORT BaseFileFind : public Orca::Plugin::Core::IFindFilter {
  Q_OBJECT
...
public:
  ...
  auto replaceAll(const QString &txt, Orca::Plugin::Core::FindFlags findFlags) -> void override;
  auto addSearchEngine(SearchEngine *searchEngine) -> void;
  /* returns the list of unique files that were passed in items */
  static auto replaceAll(const QString &txt, const QList<Orca::Plugin::Core::SearchResultItem> &items, bool preserveCase = false) -> Utils::FilePaths;
...
protected:
  ...
  static auto getAdditionalParameters(Orca::Plugin::Core::SearchResult *search) -> QVariant;
  virtual auto label() const -> QString = 0;   // see Orca::Plugin::Core::SearchResultWindow::startNewSearch
  virtual auto toolTip() const -> QString = 0; // see Orca::Plugin::Core::SearchResultWindow::startNewSearch,
...
private:
  auto openEditor(Orca::Plugin::Core::SearchResult *result, const Orca::Plugin::Core::SearchResultItem &item) -> void;
  auto doReplace(const QString &txt, const QList<Orca::Plugin::Core::SearchResultItem> &items, bool preserveCase) -> void;
  auto hideHighlightAll(bool visible) -> void;
  auto searchAgain(Orca::Plugin::Core::SearchResult *search) -> void;
  auto recheckEnabled(Orca::Plugin::Core::SearchResult *search) -> void;
  auto runNewSearch(const QString &txt, Orca::Plugin::Core::FindFlags findFlags, Orca::Plugin::Core::SearchResultWindow::SearchMode searchMode) -> void;
  auto runSearch(Orca::Plugin::Core::SearchResult *search) -> void;
