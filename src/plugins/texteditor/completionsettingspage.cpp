...
class CompletionSettingsPageWidget final : public Orca::Plugin::Core::IOptionsPageWidget {
...
auto CompletionSettingsPageWidget::apply() -> void
{
  ...
  if (m_owner->m_completionSettings != completionSettings) {
    ...
    m_owner->m_completionSettings.toSettings(Orca::Plugin::Core::ICore::settings());
  ...
  if (m_owner->m_commentsSettings != commentsSettings) {
    ...
    m_owner->m_commentsSettings.toSettings(Orca::Plugin::Core::ICore::settings());
