...
TextEditorSettings::TextEditorSettings()
{
  ...
  auto updateGeneralMessagesFontSettings = []() {
    Orca::Plugin::Core::MessageManager::setFont(d->m_fontSettings.font());
  };
  ...
  auto updateGeneralMessagesBehaviorSettings = []() {
    ...
    Orca::Plugin::Core::MessageManager::setWheelZoomEnabled(wheelZoom);
  };
...
static auto setFontZoom(int zoom) -> void
{
  ...
  d->m_fontSettings.toSettings(Orca::Plugin::Core::ICore::settings());
