...
auto IAssistProposal::basePosition() const -> int
{
  return m_basePosition;
}

auto IAssistProposal::isFragile() const -> bool
{
  return m_isFragile;
}

auto IAssistProposal::supportsPrefix() const -> bool
{
...
auto IAssistProposal::isCorrective(TextEditorWidget *editorWidget) const -> bool
{
...
auto IAssistProposal::makeCorrection(TextEditorWidget *editorWidget) -> void
{
  Q_UNUSED(editorWidget)
}

auto IAssistProposal::setFragile(bool fragile) -> void
{
  m_isFragile = fragile;
}

auto IAssistProposal::setSupportsPrefix(bool supportsPrefix) -> void
{
