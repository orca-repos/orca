...
IAssistProposalWidget::IAssistProposalWidget() : QFrame(nullptr, Qt::Popup) {}

IAssistProposalWidget::~IAssistProposalWidget() = default;

auto IAssistProposalWidget::basePosition() const -> int
{
  return m_basePosition;
}

auto IAssistProposalWidget::setBasePosition(int basePosition) -> void
{
