...
auto SnippetProvider::snippetProviders() -> const QList<SnippetProvider>&
{
...
*/
auto SnippetProvider::groupId() const -> QString
{
  return m_groupId;
}
...
*/
auto SnippetProvider::displayName() const -> QString
{
 ...
 */
auto SnippetProvider::decorateEditor(TextEditorWidget *editor, const QString &groupId) -> void
{
  for (const auto &provider : qAsConst(g_snippetProviders)) {
 ...
 */
auto SnippetProvider::registerGroup(const QString &groupId, const QString &displayName, EditorDecorator editorDecorator) -> void
{
