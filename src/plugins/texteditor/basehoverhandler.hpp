...
public:
  ...
  auto contextHelpId(TextEditorWidget *widget, int pos, const Core::IContext::HelpCallback &callback) -> void;
...
protected:
  ...
  auto setLastHelpItemIdentified(const Core::HelpItem &help) -> void;
  auto lastHelpItemIdentified() const -> const Core::HelpItem&;
  auto isContextHelpRequest() const -> bool;
  auto propagateHelpId(TextEditorWidget *widget, const Core::IContext::HelpCallback &callback) -> void;
