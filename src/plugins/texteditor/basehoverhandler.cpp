...
auto BaseHoverHandler::contextHelpId(TextEditorWidget *widget, int pos, const Core::IContext::HelpCallback &callback) -> void
{
...
auto BaseHoverHandler::setLastHelpItemIdentified(const Core::HelpItem &help) -> void
{
  m_lastHelpItemIdentified = help;
}

auto BaseHoverHandler::lastHelpItemIdentified() const -> const Core::HelpItem&
{
...
auto BaseHoverHandler::propagateHelpId(TextEditorWidget *widget, const Core::IContext::HelpCallback &callback) -> void
{
