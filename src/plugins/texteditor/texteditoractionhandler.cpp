...
public:
  ...
  auto registerActionHelper(Utils::Id id, bool scriptable, const QString &title, const QKeySequence &keySequence, Utils::Id menueGroup, Core::ActionContainer *container, std::function<void(bool)> slot) -> QAction*
  {
  ...
  auto registerAction(Utils::Id id, std::function<void(TextEditorWidget *)> slot, bool scriptable = false, const QString &title = QString(), const QKeySequence &keySequence = QKeySequence(), Utils::Id menueGroup = Utils::Id(), Core::ActionContainer *container = nullptr) -> QAction*
  {
  ...
  auto registerBoolAction(Utils::Id id, std::function<void(TextEditorWidget *, bool)> slot, bool scriptable = false, const QString &title = QString(), const QKeySequence &keySequence = QKeySequence(), Utils::Id menueGroup = Utils::Id(), Core::ActionContainer *container = nullptr) -> QAction*
  {
  ...
  auto registerIntAction(Utils::Id id, std::function<void(TextEditorWidget *, int)> slot, bool scriptable = false, const QString &title = QString(), const QKeySequence &keySequence = QKeySequence(), Utils::Id menueGroup = Utils::Id(), Core::ActionContainer *container = nullptr) -> QAction*
  {
    return registerActionHelper(id, scriptable, title, keySequence, menueGroup, container, [this, slot](bool on) {
      if (m_currentEditorWidget)
        slot(m_currentEditorWidget, on);
  ...
  auto updateCurrentEditor(Core::IEditor *editor) -> void;
...
{
  createActions();
  connect(Core::EditorManager::instance(), &Core::EditorManager::currentEditorChanged, this, &TextEditorActionHandlerPrivate::updateCurrentEditor);
}
...
auto TextEditorActionHandlerPrivate::createActions() -> void
{
  ...
  m_modifyingActions << registerAction(PRINT, [](TextEditorWidget *widget) { widget->print(Core::ICore::printer()); });
  ...
  m_modifyingActions << registerAction(DELETE_START_OF_LINE, [](TextEditorWidget *w) { w->deleteStartOfLine(); }, true, tr("Delete Line up to Cursor"), Core::use_mac_shortcuts ? QKeySequence(tr("Ctrl+Backspace")) : QKeySequence());
  ...
  m_modifyingActions << registerAction(NO_FORMAT_PASTE, [](TextEditorWidget *w) { w->pasteWithoutFormat(); }, false, tr("Paste Without Formatting"), QKeySequence(Core::use_mac_shortcuts ? tr("Ctrl+Alt+Shift+V") : QString()), G_EDIT_COPYPASTE, editMenu);
  ...
  m_modifyingActions << registerAction(REWRAP_PARAGRAPH, [](TextEditorWidget *w) { w->rewrapParagraph(); }, true, tr("&Rewrap Paragraph"), QKeySequence(Core::use_mac_shortcuts ? tr("Meta+E, R") : tr("Ctrl+E, R")), G_EDIT_FORMAT, advancedEditMenu);
  ...
  }, false, tr("&Visualize Whitespace"), QKeySequence(Core::use_mac_shortcuts ? tr("Meta+E, Meta+V") : tr("Ctrl+E, Ctrl+V")), G_EDIT_FORMAT, advancedEditMenu);
  ...
  }, false, tr("Enable Text &Wrapping"), QKeySequence(Core::use_mac_shortcuts ? tr("Meta+E, Meta+W") : tr("Ctrl+E, Ctrl+W")), G_EDIT_FORMAT, advancedEditMenu);
  ...
  m_modifyingActions << registerAction(UPPERCASE_SELECTION, [](TextEditorWidget *w) { w->uppercaseSelection(); }, true, tr("Uppercase Selection"), QKeySequence(Core::use_mac_shortcuts ? tr("Meta+Shift+U") : tr("Alt+Shift+U")), G_EDIT_TEXT, advancedEditMenu);
  m_modifyingActions << registerAction(LOWERCASE_SELECTION, [](TextEditorWidget *w) { w->lowercaseSelection(); }, true, tr("Lowercase Selection"), QKeySequence(Core::use_mac_shortcuts ? tr("Meta+U") : tr("Alt+U")), G_EDIT_TEXT, advancedEditMenu);
  m_modifyingActions << registerAction(SORT_SELECTED_LINES, [](TextEditorWidget *w) { w->sortSelectedLines(); }, false, tr("&Sort Selected Lines"), QKeySequence(Core::use_mac_shortcuts ? tr("Meta+Shift+S") : tr("Alt+Shift+S")), G_EDIT_TEXT, advancedEditMenu);
  ...
  registerAction(RESET_FONT_SIZE, [](TextEditorWidget *w) { w->zoomReset(); }, false, tr("Reset Font Size"), QKeySequence(Core::use_mac_shortcuts ? tr("Meta+0") : tr("Ctrl+0")), G_EDIT_FONT, advancedEditMenu);
...
auto TextEditorActionHandlerPrivate::updateCurrentEditor(Core::IEditor *editor) -> void
{
  if (m_currentEditorWidget)
