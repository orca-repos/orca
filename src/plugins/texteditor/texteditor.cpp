...
#include <core/core-codec-selector.hpp>
#include <core/core-base-text-find.hpp>
#include <core/core-highlight-scroll-bar-controller.hpp>
#include <core/core-interface.hpp>
#include <core/core-manhattan-style.hpp>
  ...
  LineColumnLabel(TextEditorWidget *parent) : FixedSizeClickLabel(parent), m_editor(parent)
  {
    ...
    connect(this, &FixedSizeClickLabel::clicked, ActionManager::instance(), [this] {
      ...
      QMetaObject::invokeMethod(ActionManager::instance(), [] {
        if (Command *cmd = ActionManager::command(Orca::Plugin::Core::GOTO)) {
