...
auto LanguageClientOutlineWidgetFactory::supportsEditor(Core::IEditor *editor) const -> bool
{
...
auto LanguageClientOutlineWidgetFactory::createWidget(Core::IEditor *editor) -> TextEditor::IOutlineWidget*
{
...
auto LanguageClientOutlineWidgetFactory::createComboBox(Client *client, Core::IEditor *editor) -> Utils::TreeViewComboBox*
{
  const auto textEditor = qobject_cast<TextEditor::BaseTextEditor*>(editor);
  QTC_ASSERT(textEditor, return nullptr);
