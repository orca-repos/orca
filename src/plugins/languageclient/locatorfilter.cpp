...
DocumentLocatorFilter::DocumentLocatorFilter()
{
  ...
  connect(Orca::Plugin::Core::EditorManager::instance(), &Orca::Plugin::Core::EditorManager::currentEditorChanged, this, &DocumentLocatorFilter::updateCurrentClient);
}
...
auto DocumentLocatorFilter::updateCurrentClient() -> void
{
  ...
  if (const auto client = LanguageClientManager::clientForDocument(document); client && (client->locatorsEnabled() || m_forced)) {
    ...
    m_resetSymbolsConnection = connect(document, &Orca::Plugin::Core::IDocument::contentsChanged, this, &DocumentLocatorFilter::resetSymbols);
...
static auto generateLocatorEntry(const SymbolInformation &info, Orca::Plugin::Core::ILocatorFilter *filter) -> Orca::Plugin::Core::LocatorFilterEntry
{
  Orca::Plugin::Core::LocatorFilterEntry entry;
  entry.filter = filter;
...
auto DocumentLocatorFilter::generateLocatorEntry(const SymbolInformation &info) -> Orca::Plugin::Core::LocatorFilterEntry
{
  return LanguageClient::generateLocatorEntry(info, this);
}

auto DocumentLocatorFilter::generateLocatorEntries(const SymbolInformation &info, const QRegularExpression &regexp, const Orca::Plugin::Core::LocatorFilterEntry &parent) -> QList<Orca::Plugin::Core::LocatorFilterEntry>
{
  Q_UNUSED(parent)
...
auto DocumentLocatorFilter::generateLocatorEntry(const DocumentSymbol &info, const Orca::Plugin::Core::LocatorFilterEntry &parent) -> Orca::Plugin::Core::LocatorFilterEntry
{
  Q_UNUSED(parent)
  Orca::Plugin::Core::LocatorFilterEntry entry;
  entry.filter = this;
...
auto DocumentLocatorFilter::generateLocatorEntries(const DocumentSymbol &info, const QRegularExpression &regexp, const Orca::Plugin::Core::LocatorFilterEntry &parent) -> QList<Orca::Plugin::Core::LocatorFilterEntry>
{
  QList<Orca::Plugin::Core::LocatorFilterEntry> entries;
...
template <class T>
auto DocumentLocatorFilter::generateEntries(const QList<T> &list, const QString &filter) -> QList<Orca::Plugin::Core::LocatorFilterEntry>
{
  QList<Orca::Plugin::Core::LocatorFilterEntry> entries;
...
auto DocumentLocatorFilter::matchesFor(QFutureInterface<Orca::Plugin::Core::LocatorFilterEntry> &future, const QString &entry) -> QList<Orca::Plugin::Core::LocatorFilterEntry>
{
  QMutexLocker locker(&m_mutex);
  if (!m_symbolCache)
    return {};
  if (!m_currentSymbols.has_value()) {
    ...
    QFutureWatcher<Orca::Plugin::Core::LocatorFilterEntry> watcher;
    connect(&watcher, &QFutureWatcher<Orca::Plugin::Core::LocatorFilterEntry>::canceled, &loop, &QEventLoop::quit);
...
auto DocumentLocatorFilter::accept(const Orca::Plugin::Core::LocatorFilterEntry &selection, QString * /*newText*/, int * /*selectionStart*/, int * /*selectionLength*/) const -> void
{
  if (selection.internal_data.canConvert<Utils::LineColumn>()) {
    ...
    Orca::Plugin::Core::EditorManager::openEditorAt(link, {}, Orca::Plugin::Core::EditorManager::AllowExternalEditor);
  } else if (selection.internal_data.canConvert<Utils::Link>()) {
    Orca::Plugin::Core::EditorManager::openEditorAt(qvariant_cast<Utils::Link>(selection.internal_data), {}, Orca::Plugin::Core::EditorManager::AllowExternalEditor);
  }
}
...
auto WorkspaceLocatorFilter::matchesFor(QFutureInterface<Orca::Plugin::Core::LocatorFilterEntry> &future, const QString & /*entry*/) -> QList<Orca::Plugin::Core::LocatorFilterEntry>
{
  QMutexLocker locker(&m_mutex);
...
auto WorkspaceLocatorFilter::accept(const Orca::Plugin::Core::LocatorFilterEntry &selection, QString * /*newText*/, int * /*selectionStart*/, int * /*selectionLength*/) const -> void
{
