...
class LANGUAGECLIENT_EXPORT DocumentLocatorFilter : public Orca::Plugin::Core::ILocatorFilter {
  Q_OBJECT
public:
...
private:
  ...
  template <class T>
  auto generateEntries(const QList<T> &list, const QString &filter) -> QList<Orca::Plugin::Core::LocatorFilterEntry>;
  auto generateLocatorEntries(const LanguageServerProtocol::SymbolInformation &info, const QRegularExpression &regexp, const Orca::Plugin::Core::LocatorFilterEntry &parent) -> QList<Orca::Plugin::Core::LocatorFilterEntry>;
  auto generateLocatorEntries(const LanguageServerProtocol::DocumentSymbol &info, const QRegularExpression &regexp, const Orca::Plugin::Core::LocatorFilterEntry &parent) -> QList<Orca::Plugin::Core::LocatorFilterEntry>;
  virtual auto generateLocatorEntry(const LanguageServerProtocol::DocumentSymbol &info, const Orca::Plugin::Core::LocatorFilterEntry &parent) -> Orca::Plugin::Core::LocatorFilterEntry;
  virtual auto generateLocatorEntry(const LanguageServerProtocol::SymbolInformation &info) -> Orca::Plugin::Core::LocatorFilterEntry;
...
class LANGUAGECLIENT_EXPORT WorkspaceLocatorFilter : public Orca::Plugin::Core::ILocatorFilter {
  Q_OBJECT
