...
*/
auto Aggregate::parentAggregate(QObject *obj) -> Aggregate*
{
  QReadLocker locker(&lock());
  return aggregateMap().value(obj);
}

auto Aggregate::aggregateMap() -> QHash<QObject*, Aggregate*>&
{
...
/*!
    \internal
*/
auto Aggregate::lock() -> QReadWriteLock&
{
...
auto Aggregate::deleteSelf(QObject *obj) -> void
{
  {
    QWriteLocker locker(&lock());
...
/*!
    ...
    \sa remove()
*/
auto Aggregate::add(QObject *component) -> void
{
  if (!component)
    return;
  {
...
/*!
    ...
    \sa add()
*/
auto Aggregate::remove(QObject *component) -> void
{
  if (!component)
    return;
  {
