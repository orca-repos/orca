...
#include "categorysortfiltermodel.hpp"

#include <QRegularExpression>

namespace Utils {

CategorySortFilterModel::CategorySortFilterModel(QObject *parent) : QSortFilterProxyModel(parent) {}

auto CategorySortFilterModel::filterAcceptsRow(int source_row, const QModelIndex &source_parent) const -> bool
{
