...
FakeToolTip::FakeToolTip(QWidget *parent) : QWidget(parent, Qt::ToolTip | Qt::WindowStaysOnTopHint | Qt::WindowDoesNotAcceptFocus)
{
...
auto FakeToolTip::paintEvent(QPaintEvent *) -> void
{
...
auto FakeToolTip::resizeEvent(QResizeEvent *) -> void
{
