...
class FadingIndicatorPrivate : public QWidget {
  Q_OBJECT
public:
  FadingIndicatorPrivate(QWidget *parent, FadingIndicator::TextSize size) : QWidget(parent)
  {
  ...
  auto setPixmap(const QString &uri) -> void
  {
    m_label->hide();
...
auto showText(QWidget *parent, const QString &text, TextSize size) -> void
{
...
auto showPixmap(QWidget *parent, const QString &pixmap) -> void
{
