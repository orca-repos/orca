...
/*!
    ...
    \c { orca -client file.cpp}, the working directory of the calling
...
*/
auto IPlugin::createTestObjects() const -> QVector<QObject*>
{
  return {};
}
...
*/
auto IPlugin::pluginSpec() const -> PluginSpec*
{
  return d->pluginSpec;
}
