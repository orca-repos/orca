...
/*!
    ...
    \internal
*/
auto qHash(const PluginDependency &value) -> Utils::QHashValueType
{
...
/*!
    \internal
*/
auto PluginDependency::operator==(const PluginDependency &other) const -> bool
{
...
static auto typeString(PluginDependency::Type type) -> QString
{
  ...
  case PluginDependency::Test:
    return QString(", test");
  case PluginDependency::Required: default:
    return QString();
  }
}
...
/*!
    \internal
*/
auto PluginDependency::toString() const -> QString
{
...
/*!
    ...
    reached.
*/
auto PluginSpec::name() const -> QString
{
  return d->name;
}
...
/*!
    ...
    is reached.
*/
auto PluginSpec::version() const -> QString
{
  return d->version;
}
...
*/
auto PluginSpec::compatVersion() const -> QString
{
...
/*!
    ...
    state is reached.
*/
auto PluginSpec::vendor() const -> QString
{
  return d->vendor;
}
...
/*!
    Returns the plugin copyright. This is valid after the PluginSpec::Read
     state is reached.
*/
auto PluginSpec::copyright() const -> QString
{
  return d->copyright;
}
...
/*!
    ...
    state is reached.
*/
auto PluginSpec::license() const -> QString
{
  return d->license;
}
...
/*!
    ...
    state is reached.
*/
auto PluginSpec::description() const -> QString
{
...
*/
auto PluginSpec::url() const -> QString
{
  return d->url;
}
...
*/
auto PluginSpec::category() const -> QString
{
  return d->category;
}

auto PluginSpec::revision() const -> QString
{
...
auto PluginSpec::platformSpecification() const -> QRegularExpression
{
...
*/
auto PluginSpec::isAvailableForHostPlatform() const -> bool
{
  return d->platformSpecification.pattern().isEmpty() || d->platformSpecification.match(PluginManager::platformName()).hasMatch();
}

/*!
    Returns whether the plugin is required.
*/
auto PluginSpec::isRequired() const -> bool
{
  return d->required;
}
...
*/
auto PluginSpec::isExperimental() const -> bool
{
...
*/
auto PluginSpec::isEnabledByDefault() const -> bool
{
...
*/
auto PluginSpec::isEnabledBySettings() const -> bool
{
...
*/
auto PluginSpec::isEffectivelyEnabled() const -> bool
{
...
*/
auto PluginSpec::isEnabledIndirectly() const -> bool
{
...
/*!
    ...
    command line.
*/
auto PluginSpec::isForceEnabled() const -> bool
{
...
/*!
    Returns whether the plugin is disabled via the \c -noload option on the
     command line.
*/
auto PluginSpec::isForceDisabled() const -> bool
{
...
*/
auto PluginSpec::dependencies() const -> QVector<PluginDependency>
{
...
*/
auto PluginSpec::metaData() const -> QJsonObject
{
  return d->metaData;
}
...
auto PluginSpec::argumentDescriptions() const -> PluginSpec::PluginArgumentDescriptions
{
...
*/
auto PluginSpec::location() const -> QString
{
  return d->location;
}
...
*/
auto PluginSpec::filePath() const -> QString
{
  return d->filePath;
}
...
auto PluginSpec::arguments() const -> QStringList
{
  return d->arguments;
}
...
auto PluginSpec::setArguments(const QStringList &arguments) -> void
{
...
auto PluginSpec::addArgument(const QString &argument) -> void
{
...
*/
auto PluginSpec::state() const -> PluginSpec::State
{
  return d->state;
}
...
*/
auto PluginSpec::hasError() const -> bool
{
  return d->hasError;
}
...
/*!
    ...
    error.
*/
auto PluginSpec::errorString() const -> QString
{
...
*/
auto PluginSpec::provides(const QString &pluginName, const QString &version) const -> bool
{
...
/*!
    ...
    is reached.
*/
auto PluginSpec::plugin() const -> IPlugin*
{
  return d->plugin;
}
...
/*!
    ...
    \sa PluginSpec::dependencies()
*/
auto PluginSpec::dependencySpecs() const -> QHash<PluginDependency, PluginSpec*>
{
...
/*!
    ...
    \a plugins.
*/
auto PluginSpec::requiresAny(const QSet<PluginSpec*> &plugins) const -> bool
{
  return Utils::anyOf(d->dependencySpecs.keys(), [this, &plugins](const PluginDependency &dep) {
    return dep.type == PluginDependency::Required && plugins.contains(d->dependencySpecs.value(dep));
  });
}
...
/*!
    ...
    \sa isEnabledBySettings()
*/
auto PluginSpec::setEnabledBySettings(bool value) -> void
{
  d->setEnabledBySettings(value);
}

auto PluginSpec::read(const QString &filePath) -> PluginSpec*
{
...
/*!
    \internal
*/
PluginSpecPrivate::PluginSpecPrivate(PluginSpec *spec) : q(spec)
{
...
/*!
    \internal
    Returns false if the file does not represent a Orca plugin.
*/
auto PluginSpecPrivate::read(const QString &fileName) -> bool
{
  qCDebug(pluginLog) << "\nReading meta data of" << fileName;
  name = version = compatVersion = vendor = copyright = license = description = url = category = location = QString();
...
auto PluginSpecPrivate::setEnabledBySettings(bool value) -> void
{
  enabledBySettings = value;
}

auto PluginSpecPrivate::setEnabledByDefault(bool value) -> void
{
  enabledByDefault = value;
}

auto PluginSpecPrivate::setForceEnabled(bool value) -> void
{
  forceEnabled = value;
  if (value)
    forceDisabled = false;
...
auto PluginSpecPrivate::setForceDisabled(bool value) -> void
{
  if (value)
    forceEnabled = false;
  forceDisabled = value;
...
/*!
    \internal
*/
auto PluginSpecPrivate::reportError(const QString &err) -> bool
{
  errorString = err;
  hasError = true;
  return true;
...
{
  return QCoreApplication::translate("PluginSpec", "Value for key \"%1\" is not an array of objects").arg(QLatin1String(key));
}

static inline auto msgValueIsNotAMultilineString(const char *key) -> QString
{
  return QCoreApplication::translate("PluginSpec", "Value for key \"%1\" is not a string and not an array of strings").arg(QLatin1String(key));
}

static inline auto msgInvalidFormat(const char *key, const QString &content) -> QString
{
  return QCoreApplication::translate("PluginSpec", "Value \"%2\" for key \"%1\" has invalid format").arg(QLatin1String(key), content);
}

/*!
    \internal
*/
auto PluginSpecPrivate::readMetaData(const QJsonObject &pluginMetaData) -> bool
{
  ...
  if (!value.isObject()) {
    return reportError(::ExtensionSystem::Internal::PluginSpecPrivate::tr("Plugin meta data not found"));
  }
  ...
  if (!platformSpec.isEmpty()) {
    ...
    if (!platformSpecification.isValid()) {
      return reportError(::ExtensionSystem::Internal::PluginSpecPrivate::tr("Invalid platform specification \"%1\": %2").arg(platformSpec, platformSpecification.errorString()));
    }
  }
  ...
  if (!value.isUndefined()) {
    ...
    for (const QJsonValue &v : array) {
      ...
      if (value.isUndefined()) {
        return reportError(::ExtensionSystem::Internal::PluginSpecPrivate::tr("Dependency: %1").arg(msgValueMissing(DEPENDENCY_NAME)));
      }
      if (!value.isString()) {
        return reportError(::ExtensionSystem::Internal::PluginSpecPrivate::tr("Dependency: %1").arg(msgValueIsNotAString(DEPENDENCY_NAME)));
      }
      dep.name = value.toString();
      value = dependencyObject.value(QLatin1String(DEPENDENCY_VERSION));
      if (!value.isUndefined() && !value.isString()) {
        return reportError(::ExtensionSystem::Internal::PluginSpecPrivate::tr("Dependency: %1").arg(msgValueIsNotAString(DEPENDENCY_VERSION)));
      }
      dep.version = value.toString();
      if (!isValidVersion(dep.version)) {
        return reportError(::ExtensionSystem::Internal::PluginSpecPrivate::tr("Dependency: %1").arg(msgInvalidFormat(DEPENDENCY_VERSION, dep.version)));
      }
      dep.type = PluginDependency::Required;
      value = dependencyObject.value(QLatin1String(DEPENDENCY_TYPE));
      if (!value.isUndefined() && !value.isString()) {
        return reportError(::ExtensionSystem::Internal::PluginSpecPrivate::tr("Dependency: %1").arg(msgValueIsNotAString(DEPENDENCY_TYPE)));
      }
      if (!value.isUndefined()) {
        ...
        if (typeValue.toLower() == QLatin1String(DEPENDENCY_TYPE_HARD)) {
          ...
          return reportError(::ExtensionSystem::Internal::PluginSpecPrivate::tr("Dependency: \"%1\" must be \"%2\" or \"%3\" (is \"%4\").").arg(QLatin1String(DEPENDENCY_TYPE), QLatin1String(DEPENDENCY_TYPE_HARD), QLatin1String(DEPENDENCY_TYPE_SOFT), typeValue));
        }
      }
  ...
  if (!value.isUndefined()) {
    ...
    for (const QJsonValue &v : array) {
      ...
      if (value.isUndefined()) {
        return reportError(::ExtensionSystem::Internal::PluginSpecPrivate::tr("Argument: %1").arg(msgValueMissing(ARGUMENT_NAME)));
      }
      if (!value.isString()) {
        return reportError(::ExtensionSystem::Internal::PluginSpecPrivate::tr("Argument: %1").arg(msgValueIsNotAString(ARGUMENT_NAME)));
      }
      arg.name = value.toString();
      if (arg.name.isEmpty()) {
        return reportError(::ExtensionSystem::Internal::PluginSpecPrivate::tr("Argument: \"%1\" is empty").arg(QLatin1String(ARGUMENT_NAME)));
      }
      value = argumentObject.value(QLatin1String(ARGUMENT_DESCRIPTION));
      if (!value.isUndefined() && !value.isString()) {
        return reportError(::ExtensionSystem::Internal::PluginSpecPrivate::tr("Argument: %1").arg(msgValueIsNotAString(ARGUMENT_DESCRIPTION)));
      }
      arg.description = value.toString();
      value = argumentObject.value(QLatin1String(ARGUMENT_PARAMETER));
      if (!value.isUndefined() && !value.isString()) {
        return reportError(::ExtensionSystem::Internal::PluginSpecPrivate::tr("Argument: %1").arg(msgValueIsNotAString(ARGUMENT_PARAMETER)));
      }
      arg.parameter = value.toString();
      argumentDescriptions.append(arg);
      qCDebug(pluginLog) << "Argument:" << arg.name << "Parameter:" << arg.parameter << "Description:" << arg.description;
    }
  }
...
/*!
    \internal
*/
auto PluginSpecPrivate::provides(const QString &pluginName, const QString &pluginVersion) const -> bool
{
...
/*!
    \internal
*/
auto PluginSpecPrivate::versionRegExp() -> const QRegularExpression&
{
...
/*!
    \internal
*/
auto PluginSpecPrivate::isValidVersion(const QString &version) -> bool
{
...
/*!
    \internal
*/
auto PluginSpecPrivate::versionCompare(const QString &version1, const QString &version2) -> int
{
...
/*!
    \internal
*/
auto PluginSpecPrivate::resolveDependencies(const QVector<PluginSpec*> &specs) -> bool
{
  if (hasError)
    return false;
  ...
  for (const PluginDependency &dependency : qAsConst(dependencies)) {
    ...
    if (!found) {
      if (dependency.type == PluginDependency::Required) {
        ...
        errorString.append(QCoreApplication::translate("PluginSpec", "Could not resolve dependency '%1(%2)'").arg(dependency.name).arg(dependency.version));
      }
      continue;
    }
...
auto PluginSpecPrivate::enableDependenciesIndirectly(bool enableTestDependencies) -> QVector<PluginSpec*>
{
  ...
  for (auto it = dependencySpecs.cbegin(), end = dependencySpecs.cend(); it != end; ++it) {
    if (it.key().type != PluginDependency::Required && (!enableTestDependencies || it.key().type != PluginDependency::Test))
      continue;
...
/*!
    \internal
*/
auto PluginSpecPrivate::loadLibrary() -> bool
{
  if (hasError)
    return false;
  if (state != PluginSpec::Resolved) {
  ...
  if (!loader.load()) {
    hasError = true;
    errorString = QDir::toNativeSeparators(filePath) + QString::fromLatin1(": ") + loader.errorString();
    return false;
  }
...
/*!
    \internal
*/
auto PluginSpecPrivate::initializePlugin() -> bool
{
  if (hasError)
    return false;
  if (state != PluginSpec::Loaded) {
...
/*!
    \internal
*/
auto PluginSpecPrivate::initializeExtensions() -> bool
{
  if (hasError)
    return false;
  if (state != PluginSpec::Initialized) {
...
/*!
    \internal
*/
auto PluginSpecPrivate::delayedInitialize() -> bool
{
  if (hasError)
    return false;
  if (state != PluginSpec::Running)
...
/*!
    \internal
*/
auto PluginSpecPrivate::stop() -> IPlugin::ShutdownFlag
{
  if (!plugin)
...
/*!
    \internal
*/
auto PluginSpecPrivate::kill() -> void
{
  if (!plugin)
    return;
  delete plugin;
