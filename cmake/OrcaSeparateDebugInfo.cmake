function(orca_separate_debug_info target installDestination)
    if (NOT ORCA_BUILD_WITH_SEPARATED_DEBUG_INFO)
        return()
    endif()
    ...
    get_property(skip_separate_debug_info DIRECTORY "${target_source_dir}" PROPERTY _orca_skip_separate_debug_info)
    ...
    if(APPLE)
        ...
        configure_file(
            "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/OrcaSeparateDebugInfo.Info.plist.in"
            "Info.dSYM.plist"
            )
