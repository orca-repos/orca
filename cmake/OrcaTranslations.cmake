...
function(_create_ts_custom_target name)
  ...
  add_custom_target("${_arg_TS_TARGET_PREFIX}${name}"
    COMMAND Qt6::lupdate -locations relative -no-ui-lines -no-sort "@${ts_file_list}" -ts ${ts_files}
...
function(add_translation_targets file_prefix)
  if (NOT TARGET Qt6::lrelease OR NOT TARGET Qt6::lupdate)
